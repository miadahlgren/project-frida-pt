...
import avocado from '../bilder_pt/avocado.jpg';
import keto from '../bilder_pt/ketodiet.jpg';
  ...
  return (
    <><StyledHeading>DET ÄR INTE SVÅRARE ÄN SÅHÄR</StyledHeading>
      <Swiper
        ...
        <SwiperSlide>
          <SlideTextContainer>
            <StyledSubHeading>TA INTE KROPPEN FÖR GIVEN</StyledSubHeading>
          ...
          <img src={keto} alt="this is keto" />
        </SwiperSlide>
        <SwiperSlide>
          <SlideTextContainer>
            <StyledSubHeading>BÖRJA IDAG</StyledSubHeading>
        ...
        <SwiperSlide>
          <SlideTextContainer>
            <StyledSubHeading>ENKLA MEDEL</StyledSubHeading>
          ...
          <img src={avocado} alt="this is avocado" />
        </SwiperSlide>
        <SwiperSlide>
          <SlideTextContainer>
            <StyledSubHeading>BRA BRÄNSLE</StyledSubHeading>
